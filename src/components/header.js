  ...
  return () => {
    ...
    return (
        <header id="header" className={headerStyles.header}>
                ...
                <Link className={headerStyles.title} to="/" onClick={closeNav} onKeyDown={closeNav}>
                <span className={headerStyles.logowrapper}>
                    ...
                    <span className={headerStyles.logo}><span className={headerStyles.logofirst} id="first-title">Mikkes</span><br/><span className={headerStyles.logosecond}>Blogg</span></span>
                </Link>
                ...
                <div type="text" tabIndex={0} role="button" aria-label="Toggle menu" className={headerStyles.menuicon}  onClick={openNav} onKeyDown={openNav}>
                         <div className={nav ? headerStyles.navbar1 : headerStyles.navbar}></div>
                         <div className={nav ? headerStyles.navbar2 : headerStyles.navbar}></div>
                         <div className={nav ? headerStyles.navbar3 : headerStyles.navbar}></div>
                     </div>
