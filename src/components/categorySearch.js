...
const SearchBar = ({ searchQuery, category, unFlattenResults, filter, setFilter, setSearchQuery, setBlogPosts, results, searchedPosts, posts, blogPosts, allBlogs, setSearchedPosts }) => {
