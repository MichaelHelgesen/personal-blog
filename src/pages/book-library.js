    ...
    <Layout>
      ...
      <div className={blogStyles.wrapper}>
        <div className={blogStyles.wrapperInner}>
          ...
          <p className={blogStyles.readmorewrapper}>{numberOfBooks < totalNumberOfBooks ? <button className={blogStyles.showmorebutton} onClick={upDateNumber}>Se flere ({totalNumberOfBooks - numberOfBooks})</button> : null}</p>
        </div>
      </div>
    </Layout>
